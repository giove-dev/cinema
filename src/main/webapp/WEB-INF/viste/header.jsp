    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-center">
        <div class="container-fluid ">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex">
                    <input class="form-control me-2" type="search" placeholder="Ricerca..." aria-label="Search" width="30%">
                ...
                <a class="nav-link" href="#"><svg xmlns="http://www.w3.org/2000/svg" width="20" height="16" fill="currentColor" class="bi bi-gear" viewBox="0 0 16 16">
