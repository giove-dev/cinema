    ...
    <div class="container-fluid">
        <div class="row">
            ...
            <div class="col-12 col-sm-4 align-self-end mt-5 ">
                <a
                    ...
                    id="buyOne"
                    href="/biglietto/add/${film.id}">Acquista</a>
                <a
                    class="btn btn-primary btn-sm mb-1"
                    id="subscription"
                    href="/abbonamento/buy/${film.id}">Acquista con abbonamento</a>
            </div>
        ...
        <div style="border: 1px solid rgba(0, 0, 0, 0.158)">
            <img
                src="${film.locandina }"
                alt="”biglia”"
                style="float: left; margin: 5px;margin-top:15px"
                width="29%">
                <p>

                    <dl class="row" style="background-color:rgb(202, 199, 199) ">
...
<script type="text/javascript">
    ...
    document.addEventListener("DOMContentLoaded", hideBuy, false);

    function hideBuy() {
        var tipo = localStorage.getItem("Loggato");
        if (tipo == null) {
            buySubscription.style.display = "none";
