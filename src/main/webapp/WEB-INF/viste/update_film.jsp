...
<div class="row align-items-start">
	<div class="col-12 col-sm-5 col-md-3 text-light bg-dark vh-100">
		<div class="row align-items-start">
			...
			<div class="col-9">
				...
				<h4>
					SALA <a href="http://localhost:9011/admin/sala/1"
						class="text-reset">1</a> - <a
						href="http://localhost:9011/admin/sala/2" class="text-reset">2</a>
	...
	<div class="col-12 col-sm-6 col-md-5 ms-2 mt-5 mb-5">
		<form action="/admin/updateFilm/${film.id}" method="post">
			...
			<div class="mb-3">
				<label for="titolo" class="form-label">Titolo Film</label> <input
					type="text" name="titolo" class="form-control" id="titolo"
					aria-describedby="titolo" value="${film.titolo}">
			</div>
			<div class="mb-3">
				<label for="genere" class="form-label">Genere</label> <select
					class="form-select" name="genere"
					aria-label="Default select example">
					<option selected>${film.genere}</option>
			...
			<div class="mb-3">
				...
				<textarea class="form-control" name="descrizione" path="Content"
					value="" id="descrizione" rows="10">${film.descrizione} </textarea>
			</div>

			<div class="row align-items-start">
				<div class="col-5 mb-3">
					<label for="giorno" class="form-label">Data</label> <input
						type="date" value="2021-04-01" name="giorno" class="form-control"
						id="giorno" aria-describedby="filmID" value="${film.giorno}">
				</div>
				<div class="col-5 mb-3">
					<label for="ora" class="form-label">Ora inizio</label> <input
						type="time" requried
						pattern="(0[0-9]|1[0-9]|2[0-3])(:[0-5][0-9]){2}" name="ora"
						class="form-control" id="ora" aria-describedby="userID"
						value="${film.ora}">
				</div>
				<div class="col-2 mb-3">
					<label for="sala" class="form-label">Sala</label> <input
						type="text" name="sala" class="form-control" id="sala"
						aria-describedby="sala" value="${film.sala}">
				</div>
			</div>
			<div class="mb-3">
				<label for="link_trailer" class="form-label">Link al trailer
					su youtube</label> <input type="text" name="link_trailer"
					class="form-control" id="link_trailer" aria-describedby="link"
					value="${film.link_trailer}">
			</div>
			<div class="mb-3">
				<label for="locandina" class="form-label">Link locandina</label> <input
					id="takeThis" type="text" name="locandina" class="form-control"
					id="locandina" aria-describedby="link" value="${film.locandina}">
			</div>
