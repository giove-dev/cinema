    ...
    <div class="row align-items-start">
        ...
        <div class="col 12 col-sm-7 col-md-9 mt-4">
           <div class="riga" style="background-color:GAINSBORO;">
            <h1 class="display-6 text-center"><svg xmlns="http://www.w3.org/2000/svg" style="background-color:GAINSBORO;margin-top:1rem;margin-bottom:1.5rem"  width="40" height="40" fill="currentColor" class="bi bi-camera-reels" viewBox="0 0 16 16">
...
<%--    <c:if test="${currentPage lt totalPages}">
  ...
  <ul class="pagination justify-content-center">
    <c:if test="${currentPage != 1 }">
	<li class="page-item">
      <a class="page-link" href="http://localhost:9011/admin/films/${currentPage - 1}" tabindex="-1" aria-disabled="true">Indietro</a>
    </li>
    </c:if>
    <c:forEach begin="1" end="${totalPages}" var="i">
                <c:choose>
