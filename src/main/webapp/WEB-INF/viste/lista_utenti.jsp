...
<%@include file="header.jsp"%>
  ...
  <div class="row align-items-start">
      ...
      <div class="col 12 .col-sm-7 col-md-9 mt-5">
          <div class="col-12 text-center"><div class="container-fluid"><svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-person-lines-fill" viewBox="0 0 16 16">
            <path d="M6 8a3 3 0 1 0 0-6 3 3 0 0 0 0 6zm-5 6s-1 0-1-1 1-4 6-4 6 3 6 4-1 1-1 1H1zM11 3.5a.5.5 0 0 1 .5-.5h4a.5.5 0 0 1 0 1h-4a.5.5 0 0 1-.5-.5zm.5 2.5a.5.5 0 0 0 0 1h4a.5.5 0 0 0 0-1h-4zm2 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2zm0 3a.5.5 0 0 0 0 1h2a.5.5 0 0 0 0-1h-2z"/>
          </svg>
            <h1>Lista utenti</h1> </div>
          <table class="table table-dark table-hover">
            <thead>
             ...
             <tbody>
               ...
               <tr>
                <th scope="row">	<c:out value="${utente[i].username}" /></th>
             
                <td> <c:out value="${utente[i].email}" /></td>
                    <td><c:out value="${utente[i].nome}" /></td>
                    <td><c:out value="${utente[i].cognome}" /></td>
                    <td><c:out value="${utente[i].dataiscrizione}" /></td>
                   <td><c:out value="${utente[i].ultimamodifica}" /></td>
                 </tr>
               </c:forEach>
                 <tbody>
           </table>
