...
<body>
    ...
    <nav class="navbar navbar-expand-lg navbar-dark bg-dark text-end">
        <div class="container-fluid ">
            ...
            <a style="margin-left:4rem">    <button type="button"  id="darkmode" class="btn btn-dark"><svg xmlns="http://www.w3.org/2000/svg" width="16" height="16" fill="currentColor" class="bi bi-brightness-high" viewBox="0 0 16 16">
            ...
            <div class="collapse navbar-collapse" id="navbarSupportedContent">
                ...
                <form class="d-flex" action="search" method="get">
                    ...
                    <input class="form-control me-2" id="cerca" type="date" value="2021-04-01" required pattern="\d{4}-\d{2}-\d{2}" name="keyword" placeholder="Ricerca..." aria-label="Search" width="30%">
