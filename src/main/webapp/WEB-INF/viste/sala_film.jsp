...
<%@include file="header.jsp"%>
  ...
  <div class="row align-items-start">
      <div class="col-11 col-sm-5 col-md-3 text-light bg-dark vh-100">
          <div class="row align-items-start">
      ...
      <div class="col-11 col-sm-6 col-md-8 mt-5">
          <div class="col-11 text-center"><div class="container-fluid"><svg xmlns="http://www.w3.org/2000/svg" width="70" height="70" fill="currentColor" class="bi bi-play-btn" viewBox="0 0 16 16">
			<path d="M6.79 5.093A.5.5 0 0 0 6 5.5v5a.5.5 0 0 0 .79.407l3.5-2.5a.5.5 0 0 0 0-.814l-3.5-2.5z"/>
			<path d="M0 4a2 2 0 0 1 2-2h12a2 2 0 0 1 2 2v8a2 2 0 0 1-2 2H2a2 2 0 0 1-2-2V4zm15 0a1 1 0 0 0-1-1H2a1 1 0 0 0-1 1v8a1 1 0 0 0 1 1h12a1 1 0 0 0 1-1V4z"/>
		  </svg>
            <div> 
				<c:forEach var="i" begin="0" end="0">		
						<h1> Lista sala ${film[i].sala}</h1>
				</c:forEach>
			</div></h1> </div>
          <table class="table table-dark table-hover">
            <thead>
             ...
             <tbody>
               ...
               <tr>
                <th scope="row">	<c:out value="${film[i].titolo}" /></th>
             
                <td> <c:out value="${film[i].genere}" /></td>
                    <td><c:out value="${film[i].giorno}" /></td>
                    <td><c:out value="${film[i].ora}" /></td>
