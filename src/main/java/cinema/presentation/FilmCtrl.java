...
//	@RequestMapping("/search")
	@GetMapping("films/dettaglio/search") // dubbio su cosa cambi da Get a Request. Funziona in entrambi i modi per adesso
	public String searchDettaglio(@Param("keyword")String keyword, Model model) {
